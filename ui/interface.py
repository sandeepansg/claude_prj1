...
class UserInterface:
    ...
    def show_exchange_results(self, results, time_taken, alice_b64=None, bob_b64=None):
        """Display key exchange results."""
        return self.display_handler.show_exchange_results(results, time_taken, alice_b64, bob_b64)
    ...
    def show_encryption_results(self, plaintext, ciphertext, decrypted, time_taken, feistel_properties, custom_key=None):
